...
export const EMAIL_CAMPAIGNS: Record<string, CampaignStructure> = {
  welcome: {
    ...
    throughLineTemplate: "You signed up for [product]. Here's your first step.",
    throughLineExample: "Your Hypertune trial is active. Here's how to see results in 5 minutes.",
    beats: [
      {
        id: 'confirmation',
        function: 'hook',
        job: 'Confirm what they signed up for - acknowledge their decision',
        constraint: 'COMPANY speaking TO customer. Just confirm the signup. Do NOT re-explain the product or its value prop. They already know - they signed up.',
        maxWords: 20,
        requiredElements: ['proper_noun'],
        forbidden: ['welcome to', 'thanks for signing up', 'we\'re excited', 'you may have noticed', 'last night', 'imagine', 'picture this'],
      },
      {
        id: 'value_preview',
        function: 'tension',
        job: 'Brief reminder of what they now have - not a pitch',
        constraint: 'One sentence max. Do NOT re-sell them. Just orient them to what\'s ready for them.',
        maxWords: 25,
        requiredElements: ['specific_noun'],
        forbidden: ['helping you', 'designed to', 'allows you to', 'isn\'t designed for', 'most people miss'],
      },
      {
        id: 'first_action',
        function: 'resolution',
        job: 'The ONE thing they should do first',
        constraint: 'Specific action, under 2 minutes. This is the main point of the email.',
        maxWords: 30,
      ...
      },
      {
        id: 'whats_next',
        function: 'action',
        job: 'What happens after they take that action',
        constraint: 'Concrete outcome they will see. Not vague promises.',
        maxWords: 20,
        requiredElements: [],
        forbidden: ['stay tuned', 'more to come', 'keep an eye out', 'happy gaming'],
      },
    ],
    hookConstraint: 'COMPANY speaking to customer. Confirm signup, nothing more.',
    actionConstraint: 'ONE first step. Not a pitch.',
    additionalForbidden: [
      'welcome aboard', 'glad to have you', 'journey', 'adventure',
      // Anti-narrative fabrication
      'last night', 'yesterday', 'i noticed', 'i realized', 'i was',
      'as i was', 'when i was', 'picture this', 'imagine',
    ],
  },
